      ...
      <main className="mx-auto max-w-3xl px-5 pb-24 pt-10">
        ...
        <div className="prose prose-neutral mt-10 max-w-none text-sm leading-relaxed text-foreground/90">
          ...
          <Section title="6. User responsibility">
            <p>
              Every user — shopkeeper and delivery partner — uses the platform entirely at their own
              risk. Every user is solely responsible for complying with all applicable local, state
              and national laws, including but not limited to licensing, taxation, food safety,
              transport regulations and consumer protection laws.
            </p>
          </Section>
          ...
          <Section title="8. Data & communication">
            <p>
              By registering, users consent to their name, phone number, address, shop information
              and location being shared with counterparties on the platform strictly for the purpose
              of coordinating deliveries.
            </p>
          </Section>

          <Section title="9. Acceptance">
            <p>
              By ticking the acceptance checkbox during registration and by using the platform, the
              user confirms that they have read, understood and agreed to these Terms &amp;
              Conditions in full.
            </p>
          </Section>
        </div>
